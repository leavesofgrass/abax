...
class HamLogDialog(QDialog):
    ...
    def _build(self) -> None:
        ...
        self._call.setAccessibleName("Callsign")
        ...
        self._band.setAccessibleName("Band")
        ...
        self._table.setAccessibleName("Logged contacts")
