...
FUNCTIONS.update({
    ...
    # these five also take Excel complex strings ("75+25j") for reactive loads
    "VSWR": _rf_complexable("vswr_from_z", (_R, 50.0)),
    "VSWRG": _rf_complexable("vswr_from_gamma", (_R,)),
    "REFLCOEF": _rf_complexable("reflection_coefficient", (_R, 50.0)),
    "RETURNLOSS": _rf_complexable("return_loss_db", (_R,)),
    "MISMATCHLOSS": _rf_complexable("mismatch_loss_db", (_R,)),
