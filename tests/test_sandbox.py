...
@pytest.mark.skipif(not _win, reason="AppContainer is Windows-only")
# Real-AppContainer tier; gate and reason: tests/conftest.py
# (sandbox_e2e_skip_reason). test_windows_confinement_available above still
# exercises the strategy wherever this is skipped.
