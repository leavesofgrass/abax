...
qcell's core is stdlib-only; the heavier capabilities are optional packages. Rather
...
:mod:`qcell.autodeps` (background, best-effort).
"""
...
class DependencyChooser(QDialog):
    def __init__(self, window=None) -> None:
        ...
        self._win = window
        self.setWindowTitle("qcell — optional features")
        self.resize(560, 520)
    ...
    def _build(self) -> None:
        ...
        intro = QLabel(
            "<b>qcell works right now with nothing extra.</b> These optional "
        ...
        allb.setToolTip("Everything qcell can use: the full data-science / ML "
